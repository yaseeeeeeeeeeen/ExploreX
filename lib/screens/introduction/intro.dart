    ...
    return Container(
      decoration: BoxDecoration(
          gradient: LinearGradient(
              ...
              stops: [0.5, 0.6],
              colors: [Colors.white, Color.fromARGB(151, 49, 49, 49)])),
      child: Stack(
        children: [
          PageView(
              ...
              Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage('assets/images/introImg4.jpeg'))),
              ),
              Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage('assets/images/introImg2.jpeg'))),
              ),
              Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage('assets/images/introImg3.jpeg'))),
              ),
            ],
          ),
          Container(
